...
public class EmailFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final EditText emailText = (EditText)view.findViewById(R.id.email_edit_text);
        Button emailBtn = (Button)view.findViewById(R.id.send_email_btn);

        emailBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (mListener != null) {
                    mListener.onFragmentInteraction(emailText.getText().toString());
                }
            }
        });
        return view;
